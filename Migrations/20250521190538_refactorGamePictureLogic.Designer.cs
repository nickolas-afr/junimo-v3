...
namespace junimo_v3.Migrations
{
    ...
    [Migration("20250521190538_refactorGamePictureLogic")]
    partial class refactorGamePictureLogic
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("junimo_v3.Models.Game", b =>
                {
                    ...
                    b.Property<byte[]>("GamePicture")
                        ...
                        .HasColumnName("game_picture");

                    b.Property<string>("GamePictureContentType")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("game_picture_content_type");
            ...
            modelBuilder.Entity("junimo_v3.Models.GameGenreV2", b =>
                {
                    b.Property<int>("GameId")
                        .HasColumnType("int")
                        .HasColumnName("game_id");
                    ...
                    b.HasKey("GameId", "genre");

                    b.ToTable("GameGenreV2");
                });
            ...
            modelBuilder.Entity("junimo_v3.Models.UserFriendship", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("junimo_v3.Models.UserFriendship", b =>
                {
                    b.HasOne("junimo_v3.Models.User", "Friend")
