    ...
    public partial class initialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GameGenre", x => new { x.game_id, x.genre_id });
                    table.ForeignKey(
                        name: "FK_GameGenre_Game_game_id",
                        column: x => x.game_id,
                        principalTable: "Game",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItem", x => new { x.order_id, x.game_id });
                    table.ForeignKey(
